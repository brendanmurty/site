...
Deno.test("bin/build", async(test) => {
  ...
  await test.step({
    ...
    fn: async () => {
      try {
        const publicIndexFileContents: string = await Deno.readTextFile("public/css/styles.min.css");
  ...
  await test.step({
    ...
    fn: async () => {
      try {
        const publicIndexFileContents: string = await Deno.readTextFile("public/brendan/index.html");
  ...
  await test.step({
    ...
    fn: async () => {
      try {
        const publicIndexFileContents: string = await Deno.readTextFile("public/brendan/posts.json");
  ...
  await test.step({
    ...
    fn: async () => {
      try {
        const publicIndexFileContents: string = await Deno.readTextFile("public/images/brendan/brendan-murty-2021.jpeg");
